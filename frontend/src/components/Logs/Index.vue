      ...
      >
        ...
        >
          <div class="logs-storage-modal logs-storage-modal--wide">
            ...
            <section
              ref="storageHeatmapContainerRef"
            ...
            <template v-else>
              ...
              <div class="payload-detail-grid">
                <section class="payload-detail-panel">
                  ...
                  <p
                    v-if="requestPayloadPreview.formatSkippedLarge"
                    class="payload-detail-note"
                  >
                ...
                <section class="payload-detail-panel">
                  ...
                  <p
                    v-if="responsePayloadPreview.formatSkippedLarge"
                    class="payload-detail-note"
                  >
                    {{ t('components.logs.payloadDetail.formatSkippedLarge') }}
                  </p>
